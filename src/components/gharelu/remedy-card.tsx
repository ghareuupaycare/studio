...
export const RemedyCard = ({ remedy, isFavorite, onToggleFavorite, onClick }: RemedyCardProps) => {
  return (
    <Card 
    ...
    >
      ...
      <CardContent className="p-4 space-y-2">
        <div className="flex justify-between items-start">
          <h3 className="font-headline text-lg font-bold text-primary leading-tight">{remedy.name}</h3>
        </div>
        <p className="text-sm text-muted-foreground line-clamp-2">{remedy.preparation}</p>
