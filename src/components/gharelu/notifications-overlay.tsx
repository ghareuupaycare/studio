...
export const NotificationsOverlay = ({ isOpen, onClose, lang, theme, onSelectRemedy }: NotificationsOverlayProps) => {
  const isNight = theme === 'night';
  const isHindi = lang === 'hi';

  // Logic to show the latest 3 additions as "New"
  const latestRemedies = useMemo(() => {
    return [...REMEDIES].reverse().slice(0, 3);
  }, []);
