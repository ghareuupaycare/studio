...
export const HomeView = ({ lang, theme }: HomeViewProps) => {
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700">
      ...
      <section className="w-full min-h-[32rem] rounded-[2.5rem] shadow-2xl herbal-gradient overflow-hidden flex flex-col items-center justify-center p-8 sm:p-14 text-center border border-white/20">
        
        {/* Line 1: Bold & Highly Visible Label */}
        <p className="text-xl sm:text-2xl font-black tracking-[0.2em] text-[#FDFBF7] uppercase mb-10 drop-shadow-sm">
          {isHindi ? 'आयुर्वेदिक समाधान' : 'Ayurvedic Solutions'}
        </p>

        {/* Line 2: Prominent, Extra Bold Neem Green Slogan */}
        <h2 className="text-3xl sm:text-5xl font-black text-[#14532D] leading-[1.1] max-w-xl mx-auto mb-10 drop-shadow-sm">
          {isHindi 
        ...
        <p className="text-xl sm:text-3xl font-bold text-[#1E293B] max-w-2xl mx-auto leading-relaxed mb-12 italic">
          {isHindi 
